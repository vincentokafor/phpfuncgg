...
if(isset($_POST['regSubmit'])){
    ...
    }elseif ($acct_password !== $confirmPassword){
                    ...
                    <fieldset class="wizard-fieldset text-white">
                        <div class="mt-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="profile_pic" id="frontDoc"  />
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="frontID" id="frontDoc"  />
                            </div>

                            <div class="form-group">
                                <label for="">ID CARD BACK</label>
                                <input class="form-control" type="file" name="backID" id=""  />
                            </div>
                        </div>
